		...
		<% } else if(req.getState().equalsIgnoreCase("Accettata")) {%>	
			<div class="row text-center" style="margin-bottom: 25px;">				
				<div class="column" style="width: 33%;">
					<a href="/TutoratoSmart/View/tutor/appointment.jsp"><input class="btn btn-success" id="confirmAppointment" type="button" value="Appuntamento effettuato"></a>
				</div>
				<div class="column" style="width: 33%;">
		...
		<% } else { %>	
			<div class="row text-center" style="margin-bottom: 25px;">
				<div class="column" style="width: 100%;">
					...
					%>
						<input class="btn btn-primary" type="button" id="back" value="Indietro" onclick="location.href='/TutoratoSmart/View/tutor/calendar.jsp';">
					<% } else { %>	
						<input class="btn btn-primary" type="button" id="back" value="Indietro" onClick="history.go(-1);return true;">
					<% } %>
				</div>
