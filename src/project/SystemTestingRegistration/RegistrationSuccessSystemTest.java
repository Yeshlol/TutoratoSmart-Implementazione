...
public class RegistrationSuccessSystemTest {
  ...
  @Test
  public void registrationSuccessSystem() {
    ...
    driver.findElement(By.cssSelector(".row:nth-child(3) > .form-group:nth-child(1)")).click();
