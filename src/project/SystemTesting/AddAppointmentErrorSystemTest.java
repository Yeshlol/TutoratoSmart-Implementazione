...
public class AddAppointmentErrorSystemTest {
  ...
  @Test
  public void addAppointmentErrorSystem() {
   ...
   driver.get("http://localhost:8080/TutoratoSmart/ShowRequest?id=5&flag=3"); //MODIFICARE
