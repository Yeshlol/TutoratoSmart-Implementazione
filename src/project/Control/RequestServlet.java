...
public class RequestServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (flag == 1) {												// 1 = Registrazione nuova prenotazione da parte dello studente.
			...
			if(time.length()==0) {
				throw new IllegalArgumentException("Non Ë stato selezionato l'orario");
			}
			...
			if(stringDate.length()==0) {
				throw new IllegalArgumentException("Non Ë stato selezionato il giorno");
			}
			...
			/*if(date.getDay()!=3 && date.getDay()!=4) {
				throw new IllegalArgumentException("Il giorno selezionato non Ë corretto");
			}*/
