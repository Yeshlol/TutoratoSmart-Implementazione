...
@WebServlet("/ShowActivityTutoringSupervision")
public class ShowActivityServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
			...
			request.getSession().setAttribute("activity",activityBean);
		} catch (SQLException e) {
			e.printStackTrace();
		}
		
		RequestDispatcher dispatcher = request.getRequestDispatcher("/View/commission/activityInfo.jsp");
